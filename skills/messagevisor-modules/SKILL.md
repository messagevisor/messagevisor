---
name: messagevisor-modules
description: "Use this skill when adding, ordering, debugging, or writing Messagevisor modules such as ICU, interpolation, Featurevisor, missing-translation reporting, or custom runtime transforms."
---

# Messagevisor modules
...
Use modules when behavior changes evaluated output or runtime behavior. Use parsers for source file formats and plugins for CLI workflows.
...
3. Compare project modules with runtime modules. They should usually match.
...
If runtime behavior still differs, inspect the built datafile and the app's SDK initialization. Module mismatch is a common cause.
